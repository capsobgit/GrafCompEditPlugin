...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react_flow_renderer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-flow-renderer */ "../node_modules/react-flow-renderer/dist/esm/index.js");
/* harmony import */ var _components_CustomNode__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/CustomNode */ "./components/CustomNode.tsx");
...
var App = function App(props) {
  ...
  var fitBounds = Object(react_flow_renderer__WEBPACK_IMPORTED_MODULE_2__["useReactFlow"])().fitBounds; //Panel wird mit props für width,height gesetzt
  ...
  var nodeTypes = Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])(function () {
    return {
      customNode: _components_CustomNode__WEBPACK_IMPORTED_MODULE_3__["default"]
    };
  }, []);

  var _a = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(initialNodes), 2),
      nodes = _a[0],
      setNodes = _a[1];

  var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(initialEdges), 2),
      edges = _b[0],
      setEdges = _b[1];

  var onNodesChange = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (changes) {
    return setNodes(function (nds) {
      return Object(react_flow_renderer__WEBPACK_IMPORTED_MODULE_2__["applyNodeChanges"])(changes, nds);
    });
  }, [setNodes]);
  var onEdgesChange = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (changes) {
    return setEdges(function (eds) {
      return Object(react_flow_renderer__WEBPACK_IMPORTED_MODULE_2__["applyEdgeChanges"])(changes, eds);
    });
  }, [setEdges]);
  var onConnect = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (connection) {
    return setEdges(function (eds) {
      return Object(react_flow_renderer__WEBPACK_IMPORTED_MODULE_2__["addEdge"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, connection), {
        animated: true
      }), eds);
    });
  }, [setEdges]);

  var _c = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(null), 2),
      rfInstance = _c[0],
      setRfInstance = _c[1];

  var onSave = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function () {
    if (rfInstance) {
      var flow = rfInstance.toObject();
      localStorage.setItem(flowKey, JSON.stringify(flow)); //Hier Datenbank call
    }
  }, [rfInstance]);
  var setViewport = Object(react_flow_renderer__WEBPACK_IMPORTED_MODULE_2__["useReactFlow"])().setViewport;
  var onRestore = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function () {
    var restoreFlow = function restoreFlow() {
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(void 0, void 0, void 0, function () {
        var flow, _a, _b, x, _c, y, _d, zoom;

        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_e) {
          flow = JSON.parse(localStorage.getItem(flowKey));

          if (flow) {
            _a = flow.viewport, _b = _a.x, x = _b === void 0 ? 0 : _b, _c = _a.y, y = _c === void 0 ? 0 : _c, _d = _a.zoom, zoom = _d === void 0 ? 1 : _d;
            setNodes(flow.nodes || []);
            setEdges(flow.edges || []);
            setViewport({
              x: x,
  ...
  var onAdd = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function () {
    var newNode = {
      id: getNodeId(),
      data: {
        label: 'Added node'
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_flow_renderer__WEBPACK_IMPORTED_MODULE_2__["default"], {
    nodes: nodes,
    edges: edges,
    onNodesChange: onNodesChange,
    onEdgesChange: onEdgesChange,
    ...
    onClick: onRestore
  }, "restore"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("button", {
    onClick: onAdd
  }, "add node"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("button", {
    onClick: null
  })), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_flow_renderer__WEBPACK_IMPORTED_MODULE_2__["MiniMap"], null), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_flow_renderer__WEBPACK_IMPORTED_MODULE_2__["Controls"], null));
};
